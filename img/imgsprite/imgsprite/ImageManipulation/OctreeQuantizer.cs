/*
  Code extracted from Morgan Skinner's article on optimizing color quantization.
  The article can be found at http://msdn2.microsoft.com/en-us/library/aa479306.aspx.
*/
...
namespace ImageManipulation
{
    ...
    public unsafe class OctreeQuantizer : Quantizer
    {
        ...
        private static int GetMaxColorBits(BitDepth pBitDepth)
        {
            switch (pBitDepth)
            {
                case BitDepth.Bits8:
                ...
                case BitDepth.Bits24:
                    return 24;
                default:
                    throw new ArgumentOutOfRangeException("pBitDepth");
            }
        }

        private static int GetMaxColors(BitDepth pBitDepth)
        {
            switch (pBitDepth)
            {
                case BitDepth.Bits8:
